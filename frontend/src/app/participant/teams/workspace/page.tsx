  ...
  return (
    <div className="bg-surface min-h-[calc(100vh-80px)] overflow-x-hidden">
      ...
      <div className="fixed bottom-8 right-8 z-50 group">
        <button className="bg-primary-container text-on-primary-container p-4 rounded-2xl shadow-xl hover:scale-110 active:scale-95 transition-all flex items-center gap-3">
